...
public class SauceReceivedDto {
    ...
    public SauceReceivedDto(Long sauceId, Long userId, String name, String manufacturer, String description, String mainPepper, String imageUrl, int heat, int likes, int dislikes) {
